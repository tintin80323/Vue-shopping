<template>
  <div>
    ...
    <table class="table mt-4">
      <thead>
        <tr>
          <th class="text-center" width="200">分類</th>
          <th class="text-center">產品名稱</th>
          <th width="200" class="text-center">原價</th>
          <th width="200" class="text-center">售價</th>
          <th width="200" class="text-center">是否啟用</th>
      ...
      <tbody>
        <tr v-for="item in products" :key="item.id">
          ...
          <td class="text-center">{{ item.origin_price | currency }}</td>
  ...
  methods: {
    ...
    openModal(isNew, item) {
      if (isNew) {
        ...
        (this.tempProduct = Object.assign({}, item)), (this.isNew = false);
      }
